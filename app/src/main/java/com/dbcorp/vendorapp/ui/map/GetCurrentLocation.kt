...
class GetCurrentLocation : Fragment(), OnMapReadyCallback {
    companion object {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        sessionUser= UserSharedPreference(activity)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        pinMap.setOnClickListener {
            ...
            if(mapLocation.text.length==0){
Util.show(mContext,"Please select on done")
