...
public class PlacesAdapter extends ArrayAdapter<AutocompletePrediction> implements Filterable {
    ...
    public PlacesAdapter(Context context, PlacesClient placesClient) {
        super(context, R.layout.place_adapter_layout, R.id.txtMain);
    ...
    public View getView(int position, View convertView, @NonNull ViewGroup parent) {
        ...
        TextView textView1 = row.findViewById(R.id.txtMain);
        TextView textView2 = row.findViewById(R.id.txtSub);
        if (item != null) {
