...
public class SubCategoryAdapter extends RecyclerView.Adapter<SubCategoryAdapter.MyViewHolder> {
    ...
    private ArrayList<SubCategory> listData=new ArrayList<>();
    ...
    public SubCategoryAdapter(ArrayList<SubCategory> getListData, OnMeneuClickListnser onLiveTestClickListener, Context context) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        SubCategory data=listData.get(position);
...
holder.cardView.setOnClickListener(v->{
    ...
    public interface OnMeneuClickListnser{
        void onOptionClick(SubCategory data, int pos);
    }
